<div {{ $attributes }}>
    <div class="inline-flex w-full items-center">
        ...
        @endif
        <div class="flex items-center bg-white border-[#E2E8F0] hover:border-customPrimary border rounded-lg w-full max-w-full shadow-sm">
            <div class="pl-4 text-customBlack/70">
